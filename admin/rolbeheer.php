...
$gebruiker = Gebruiker::findGebruikerById($_GET['id']);
...
<body>
    ...
    <div class="Labels">
        <form method="post" action="rolbeheer.php">
            <label for="rol">Naam: <?php echo $gebruiker->voornaam; ?> <?php echo $gebruiker->achternaam; ?></label><br>
    </div>
    <div class="rolTextbox">
        <select name="rol" class="rolTextbox">
            <option value="admin">Admin</option>
            <option value="employee">medewerker</option>
        </select>
        <button type="submit" name="submit" value="<?php echo $gebruiker->gebruikerid; ?>" class="rolButton">Rol aanpassen</button>
...
if (isset($_COOKIE['speelhuys-session'])) {
    ...
    if (isset($_POST['submit'])) {
        $gebruikerid = $_POST['submit'];
        $rol = $_POST['rol'];

        Gebruiker::updateRol($gebruikerid, $rol);
